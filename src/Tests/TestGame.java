...
public class TestGame {
    public static void main(String[] args){
        ...
        Entity putHoleEntity = new Entity(new TexturedModel(OBJLoader.loadObjModel("underHole",loader),black),new Vector3f(2,0.01f,2),0,0,0,1);
        PutHole putHole = new PutHole(putHoleEntity);
        ...
        while (!Display.isCloseRequested()){
            ...
            renderer.processEntity(putHoleEntity);
            guiGame.render();
